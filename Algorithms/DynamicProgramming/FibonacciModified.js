...
/**
* since JavaScript doesn't support big numbers, in order to implement solution, 
* I was using a 3rd party library
*/
function processData(input) {
    
	var dataArray = input.split(" ");

	var a = new BigNumber(dataArray[0].toString());
	var b = new BigNumber(dataArray[1].toString());
	var n = parseInt(dataArray[2]);
	
	n = n-2;
	
	while(n > 0) {
		n--;
		var calcRes = calcResult(a, b);
		a = new BigNumber(calcRes[0].toString());
		b = new BigNumber(calcRes[1].toString());
	}
